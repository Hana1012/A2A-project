...
from agent import highO_lowN_InvestmentAgent
from typing_extensions import override


class highO_lowN_AgentExecutor(AgentExecutor):
    """high Openness low  Neuroticism Investment AgentExecutor."""

    def __init__(self):
        self.agent = highO_lowN_InvestmentAgent()
